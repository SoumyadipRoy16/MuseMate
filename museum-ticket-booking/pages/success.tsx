...
export default function Success() {
    ...
    if (query.session_id) {
      ...
      fetch('/api/send-email', {
        ...
        .then(data => {
          ...
          setMessages(prev => [
            ...prev,
            { text: "The confirmation email has been successfully sent.", sender: 'bot' }
          ]);
        })
        .catch(error => {
          ...
          setMessages(prev => [
            ...prev,
            { text: "There was an error sending the email. Please try again later.", sender: 'bot' }
          ]);
        });
    }
  }, [query.session_id]);
  ...
  const handleSend = async () => {
    // Implement the handleSend functionality if needed
  };
